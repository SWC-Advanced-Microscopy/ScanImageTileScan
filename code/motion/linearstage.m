...
%
% The linearstage abstract class declares methods and properties that are used 
% move linear actuators, linear stages, PIFOCs, etc. This class is "attached" 
% to an object that inherits linearcontroller using linearcontroller.attachLinearStage. 
...
% Rob Campbell - Basel 2016
    ...
    properties
      ...
      axisID
       ...
       axisName
        % This string defines the name (role) of the axis.
